                    ...
                    <div class="row g-3">
                        <div class="mb-3">
                            <div class="form-check form-check-inline">
                                <input style="border-color: green ;  " class="form-check-input" type="radio" name="genre" id="inlineRadio1" value="Mr." required>
                                <label class="form-check-label" for="inlineRadio1">Mr.</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input style="border-color: green ;  " class="form-check-input" type="radio" name="genre" id="inlineRadio1" value="Mme." >
                                <label class="form-check-label" for="inlineRadio2">Mme.</label>
                            </div>

                        </div>
                        <div class="col-auto">
                            <input type="text" placeholder="Nom" name="nom" class="form-control" aria-describedby="emailHelp" required>
                        </div>
                        ...
                        <select class="col-auto" name="age" class="form-select" style="border-radius: 0.3rem;" multiple required>
